...
- Name: auth-crud.spec.js >> Authentication Tests >> should show validation error with empty fields
- Location: EAEmployeeWithTestSprite\tests\playwright\e2e\auth-crud.spec.js:29:7
